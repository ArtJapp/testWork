...
public class Key {
    ...
    @Expose
    private String cr;
    @SerializedName("googleHost")
    @Expose
    private String googleHost;
    @SerializedName("disableCnTwTranslation")
    @Expose
    ...
    @SerializedName("siteSearchFilter")
    @Expose
    private String siteSearchFilter;
    @SerializedName("exactTerms")
    @Expose
    private String exactTerms;
    @SerializedName("excludeTerms")
    @Expose
    private String excludeTerms;
    @SerializedName("linkSite")
    @Expose
    private String linkSite;
    @SerializedName("orTerms")
    @Expose
    private String orTerms;
    @SerializedName("relatedSite")
    @Expose
    private String relatedSite;
    @SerializedName("dateRestrict")
    @Expose
    ...
    @SerializedName("imgColorType")
    @Expose
    private String imgColorType;
    @SerializedName("imgDominantColor")
    @Expose
